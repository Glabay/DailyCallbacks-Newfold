...
import xyz.glabaystudios.crawlers.impl.SocialCrawler;
import xyz.glabaystudios.exceptions.NetworkExceptionHandler;
...
public class WhoisLookup {
	...
	public void filterDumpedData() {
		...
		} else if (getResult().getRegistrar().equalsIgnoreCase("REGISTER.COM, INC.") || getResult().getRegistrar().equalsIgnoreCase("NETWORK SOLUTIONS, INC.") || getResult().getRegistrar().equalsIgnoreCase("NETWORK SOLUTIONS, LLC"))
